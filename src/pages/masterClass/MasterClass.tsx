  ...
  return (
    <div className="layout">
      ...
      <div className="layout-block">
        ...
        <div className="layout-subtitle">What is Rangle?</div>
        RangleUI is a set of react components and utilities for the rapid
        development of web applications. The library includes all the main UI
        units from buttons and input fields to modals and windows. This is not a
        framework, Rangle provides ready-made interactive and styled components,
        but does not tell you how you should build your application.
        <br />
        <br />
        Posted by{" "}
        <a className="link" href={`https://t.me/${tagName.slice(1)}`}>
          {tagName}
        </a>
      </div>
